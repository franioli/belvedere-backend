...
class Survey(models.Model):
    ...
    def __str__(self):
        return f"Survey {self.year or self.id}"
...
class Point(models.Model):
    ...
    def __str__(self):
        return self.label or f"Point {self.id}"


class PointMeasurement(models.Model):
    id = models.IntegerField(primary_key=True)
...
class Products2D(models.Model):
    id = models.IntegerField(primary_key=True)
    fk_surveys = models.ForeignKey(
        "Surveys", models.DO_NOTHING, db_column="fk_surveys", blank=True, null=True
    )
    ...
    reference_field = models.CharField(
        db_column="reference_", max_length=254, blank=True, null=True
    )
    epsg = models.BigIntegerField(blank=True, null=True)
    proj4 = models.CharField(max_length=254, blank=True, null=True)
    file_size_field = models.DecimalField(
        db_column="file_size_",
        max_digits=65535,
...
class Products3D(models.Model):
    ...
    license = models.CharField(max_length=254, blank=True, null=True)
    path = models.CharField(max_length=254, blank=True, null=True)
    average_po = models.DecimalField(
        max_digits=65535, decimal_places=65535, blank=True, null=True
    )
