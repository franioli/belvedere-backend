...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameField(model_name='flight', old_name='average_gs', new_name='average_gsd'),
        migrations.RenameField(model_name='flight', old_name='average_he', new_name='average_height'),
        migrations.RenameField(model_name='flight', old_name='camera_nam', new_name='camera_name'),
        migrations.RenameField(model_name='flight', old_name='focal_leng', new_name='focal_length'),
        migrations.RenameField(model_name='flight', old_name='global_acc', new_name='global_accuracy'),
        migrations.RenameField(model_name='flight', old_name='n_checkpoi', new_name='n_checkpoints'),
        migrations.RenameField(model_name='flight', old_name='n_controlp', new_name='n_controlpoints'),
        migrations.RenameField(model_name='flight', old_name='sensor_siz', new_name='sensor_size'),
        ...
        migrations.AlterField(
            model_name='product2d',
            name='data_type',
            field=models.CharField(help_text='Product type, e.g. ortofoto, dsm.', max_length=64),
        ),
        migrations.AlterField(
            model_name='product2d',
            name='survey',
        ...
        migrations.AlterField(
            model_name='product3d',
            name='data_type',
            field=models.CharField(help_text='Product type, e.g. pointcloud, mesh.', max_length=64),
        ),
        migrations.AlterField(
            model_name='product3d',
            name='survey',
